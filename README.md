...
> **R:**
el numero es mucho mayor porque el preprocesador reemplaza la linea #include <stdio.h>
por el contenido completo de ese archivo agregande cientos de lineas de definiciones.
---
...
> **R:**
ocurre porque los comentarios estan hechos para los seres humanos, no para la computadora y el preprocesador actua como "limpiador".
...
> **R:**
2185:    printf("=== Laboratorio de Compilacion en C (v%s) ===\n\n", "1.0");
...
> **R:**
el formato # N "archivo" le dice al compilador que el codigo siguiente comienza en la linea N del archivo "archivo".
el bloque que contiene la declaracion pertenece al archivo stdio.h
---
...
> **R:**
Su objetivo es preperar el espacio de la memoria para la funcion, salvar el estado del programa antes de la llamada y mover los argumentos recibidos a los registros de memoria donde se operara con ellos.
---
...
> **R:**
En programa.o aparece como U porque el archivo programa.c solo hace una llamada a la funcion, sabe que existe pero no como funciona.
en cambio en matematica.o aparece como T porque en ese archivo es donderealmente esta el cuerpo de la funcion.
...
> **R:**
00000001400015c0 T area_circulo
...
> **R:**
Aun quedan porque son simbolos que el programa no incluye dentro de si mismo para ahorrar espacio.
El encargado de reolverlolo es el cargador del sistema operativo y
los resuelve en tiempo de ejecucion.
---
...
> **R:**
Una macro funcion es una simple sustitucion de texto y una funcion real es un bloque de codigo real con su propia direccion de memoria.
La macro funcion desaparece en el preprocesamiento, el preprocesador cambia el nombre de la macro por su codigo antes de la compilacion y la funcion real desaparece en el enlazado cuando se convierte en una direccion de memoria dentro del ejecutable.
La macro funcion no tiene verificacion de tipos ya que es solo texto por lo que puedes pasarle cualquier cosa y el error saltara al intentar compilar el codigo y la funcion real si tiene verificacion de tipos, el compilador verifica que los argumentos coincidan con al definicion.
---
...
> **R:**
T es una seccion de solo lectura y ejecutable (codigo) y D es una seccion de lectura y escritura pero no ejecutable (variables con valor).
...
> **R:**
Uso windows, no ejecute este comando.
